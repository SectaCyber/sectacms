...
Classifiers are enabled by default on all ``sectaPage`` models. The filtering HTML UI
...
Wagtail Secta provides two filtering templates by default, a Bootstrap nav in
``sectacms/includes/classifier_nav.html`` and a simple select/dropdown form in
``sectacms/includes/classifier_dropdowns.html``. Most likely, you will want to implement your
