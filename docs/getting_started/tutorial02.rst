...
a "block" and provides a different format of content. Wagtail Secta is heavily based on Bootstrap CSS
...
First, let's make a big flashy hero unit. A hero unit in Wagtail Secta is a block that allows for
