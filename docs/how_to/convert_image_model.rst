...
Before starting this guide, ensure you have updated to the latest Wagtail Secta,
...
At this point the database tables of existing sectacms models have FK pointing
...
To help with your database update, below is a list of each concrete secta
model which references the Image. A `search query of the source code
<https://github.com/SectaCyber/sectacms/search?l=Python&q=get_image_model_string>`_
can also yield specific results.

* ``sectacms.models.sectaPage.cover_image``

* ``sectacms.models.sectaPage.og_image``

* ``sectacms.models.sectaPage.struct_org_logo``

* ``sectacms.models.sectaPage.struct_org_image``

* ``sectacms.models.CarouselSlide.image``

* ``sectacms.models.LayoutSettings.logo``

* ``sectacms.models.LayoutSettings.favicon``
