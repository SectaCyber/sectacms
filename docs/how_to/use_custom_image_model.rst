Using a Custom Image Model in Wagtail Secta
=========================================

.. versionadded:: 0.19

    Added support for custom image models. You must be on Wagtail Secta version
...
empty database and have **never run sectacms migrations!**
