...
class CreateProject(TemplateCommand):
    ...
    help = "Creates the directory structure for a new Wagtail Secta project."
    ...
    def handle(self, **options):
        ...
        Secta_path = os.path.dirname(sectacms.__file__)
        if not options["template"]:
            options["template"] = "basic"
        template_path = os.path.join(
            os.path.join(Secta_path, "project_template"), options["template"]
        )

        # Check if provided template is built-in to sectacms,
        ...
        # Set options
        message = "Creating a Wagtail Secta project called %(project_name)s"
        ...
        options["sectacms_release"] = sectacms.release
