...
class ClassifierTermChooserBlock(blocks.FieldBlock):
    ...
    def target_model(self):
        return resolve_model_string("sectacms.ClassifierTerm")
...
class sectaAdvSettings(blocks.StructBlock):
    """
...
class sectaAdvTrackingSettings(sectaAdvSettings):
    """
    sectaAdvSettings plus additional tracking fields.
    """
...
class sectaAdvColumnSettings(sectaAdvSettings):
    """
    BaseBlockSettings plus additional column fields.
    """

    column_breakpoint = blocks.ChoiceBlock(
        choices=Secta_settings.Secta_FRONTEND_COL_BREAK_CHOICES,
        default=Secta_settings.Secta_FRONTEND_COL_BREAK_DEFAULT,
        required=False,
...
class BaseBlock(blocks.StructBlock):
    """
    Common attributes for all blocks used in Wagtail Secta.
    """

    # subclasses can override this to determine the advanced settings class
    advsettings_class = sectaAdvSettings
    ...
    def __init__(self, local_blocks=None, **kwargs):
        ...
        choices = Secta_settings.Secta_FRONTEND_TEMPLATES_BLOCKS.get(
            "*", []
        ) + Secta_settings.Secta_FRONTEND_TEMPLATES_BLOCKS.get(klassname, [])
