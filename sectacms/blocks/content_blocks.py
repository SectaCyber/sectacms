...
class AccordionBlock(BaseBlock):
    ...
    accordion = SnippetChooserBlock("sectacms.Accordion")

    class Meta:
        template = "sectacms/blocks/accordion_block.html"
        icon = "bars"
        label = "Accordion"
...
class CardBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/card_foot.html"
        icon = "cr-list-alt"
        label = _("Card")
...
class CarouselBlock(BaseBlock):
    ...
    carousel = SnippetChooserBlock("sectacms.Carousel")

    class Meta:
        icon = "image"
        label = _("Carousel")
        template = "sectacms/blocks/carousel_block.html"
...
class FilmStripBlock(BaseBlock):
    ...
    film_strip = SnippetChooserBlock("sectacms.FilmStrip")

    class Meta:
        icon = "image"
        label = _("Film Strip")
        template = "sectacms/blocks/film_strip_block.html"
...
class ImageGalleryBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/image_gallery_block.html"
        icon = "image"
...
class ModalBlock(ButtonMixin, BaseLayoutBlock):
    ...
    class Meta:
        template = "sectacms/blocks/modal_block.html"
...
class NavExternalLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sectacms/blocks/external_link_block.html"
...
class NavPageLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sectacms/blocks/page_link_block.html"
        label = _("Page Link")
...
class NavDocumentLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sectacms/blocks/document_link_block.html"
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/pricelistitem_block.html"
        icon = "cr-usd"
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/pricelist_block.html"
        icon = "cr-usd"
        label = _("Price List")
...
class ContentWallBlock(BaseBlock):
    ...
    content_wall = SnippetChooserBlock("sectacms.ContentWall")
    ...
    class Meta:
        ...
        template = "sectacms/blocks/content_wall_block.html"
...
class ReusableContentBlock(BaseBlock):
    ...
    content = SnippetChooserBlock("sectacms.ReusableContent")

    class Meta:
        icon = "cr-recycle"
        label = _("Reusable Content")
        template = "sectacms/blocks/reusable_content_block.html"
