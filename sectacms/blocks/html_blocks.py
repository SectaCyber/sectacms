...
class ButtonBlock(ButtonMixin, BaseLinkBlock):
    ...
    class Meta:
        template = "sectacms/blocks/button_block.html"
...
class DownloadBlock(ButtonMixin, BaseBlock):
    ...
    advsettings_class = sectaAdvTrackingSettings

    class Meta:
        template = "sectacms/blocks/download_block.html"
        icon = "download"
        label = _("Download")
...
class EmbedGoogleMapBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/google_map.html"
        icon = "cr-map"
        label = _("Google Map")
...
class EmbedVideoBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/embed_video_block.html"
        icon = "media"
        label = _("Embed Media")
...
class H1Block(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/h1_block.html"
        icon = "cr-header"
        label = _("Heading 1")
...
class H2Block(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/h2_block.html"
        icon = "cr-header"
        label = _("Heading 2")
...
class H3Block(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/h3_block.html"
        icon = "cr-header"
        label = _("Heading 3")
...
class TableBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/table_block.html"
        icon = "table"
        label = "Table"
...
class ImageBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/image_block.html"
        icon = "image"
        label = _("Image")
...
class ImageLinkBlock(BaseLinkBlock):
    ...
    class Meta:
        template = "sectacms/blocks/image_link_block.html"
        icon = "image"
        label = _("Image Link")
        value_class = LinkStructValue
...
class PageListBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/pagelist_block.html"
        icon = "list-ul"
    ...
    def get_context(self, value, parent_context=None):
        ...
        # try to use the sectaPage `get_index_children()`,
        # but fall back to get_children if this is a non-sectaPage
        if hasattr(indexer, "get_index_children"):
            ...
            if value["classified_by"]:
                try:
                    ...
                    # `pages` is not a queryset, or is not a queryset of sectaPage.
                    logger.warning(
                        (
...
class PagePreviewBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/pagepreview_block.html"
...
class QuoteBlock(BaseBlock):
    ...
    class Meta:
        template = "sectacms/blocks/quote_block.html"
        icon = "openquote"
        label = _("Quote")
...
class RichTextBlock(blocks.RichTextBlock):
    class Meta:
        template = "sectacms/blocks/rich_text_block.html"
