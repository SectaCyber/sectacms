...
from .base_blocks import BaseLayoutBlock, sectaAdvColumnSettings
...
class ColumnBlock(BaseLayoutBlock):
    ...
    column_size = blocks.ChoiceBlock(
        choices=Secta_settings.Secta_FRONTEND_COL_SIZE_CHOICES,
        default=Secta_settings.Secta_FRONTEND_COL_SIZE_DEFAULT,
        required=False,
        label=_("Column size"),
    )

    advsettings_class = sectaAdvColumnSettings

    class Meta:
        template = "sectacms/blocks/column_block.html"
        icon = "placeholder"
        label = "Column"
...
class GridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sectacms/blocks/grid_block.html"
        icon = "cr-columns"
...
class CardGridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sectacms/blocks/cardgrid_deck.html"
        icon = "cr-th-large"
        label = _("Card Grid")
...
class HeroBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sectacms/blocks/hero_block.html"
        icon = "cr-newspaper-o"
        label = "Hero Unit"
