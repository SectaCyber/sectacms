    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', sectacms.fields.sectaStreamField([], blank=True)),
                ('carousel', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='carousel_slides', to='sectacms.Carousel', verbose_name='Carousel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_css_class', models.CharField(blank=True, max_length=255, verbose_name='Custom CSS Class')),
                ('custom_id', models.CharField(blank=True, max_length=255, verbose_name='Custom ID')),
                ('content', sectacms.fields.sectaStreamField([], blank=True, verbose_name='Content')),
            ],
            options={
                'verbose_name': 'Footer',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navbar_format', models.CharField(blank=True, choices=[('', 'Default Bootstrap Navbar'), ('secta-navbar-center', 'Centered logo at top')], default='', max_length=50, verbose_name='Navbar format')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_css_class', models.CharField(blank=True, max_length=255, verbose_name='Custom CSS Class')),
                ('custom_id', models.CharField(blank=True, max_length=255, verbose_name='Custom ID')),
                ('menu_items', sectacms.fields.sectaStreamField([], blank=True, verbose_name='Navigation links')),
            ],
            options={
