    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('content', sectacms.fields.sectaStreamField(blank=True, use_json_field=True)),
                ...
                ('accordion', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='accordion_panels', to='sectacms.accordion', verbose_name='Accordion')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
