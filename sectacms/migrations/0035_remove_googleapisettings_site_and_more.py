...
def copy_settings(apps, schema_editor):
    ...
    GeneralSettings = apps.get_model("sectacms", "GeneralSettings")
    GoogleApiSettings = apps.get_model("sectacms", "GoogleApiSettings")
    MailchimpApiSettings = apps.get_model("sectacms", "MailchimpApiSettings")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sectacms', '0034_delete_adasettings'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='layoutsettings',
            options={'verbose_name': 'Secta Settings'},
        ),
        migrations.AddField(
