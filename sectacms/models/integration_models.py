...
from sectacms.api.mailchimp import MailchimpApi
...
class MailchimpSubscriberIntegrationWidget(Input):
    template_name = (
        "sectacms/formfields/mailchimp/subscriber_integration_widget.html"
    )
    js_template_name = (
        "sectacms/formfields/mailchimp/subscriber_integration_js.html"
    )
