...
class _DefaultSettings:
    Secta_PROTECTED_MEDIA_URL = "/protected/"
    Secta_PROTECTED_MEDIA_ROOT = os.path.join(settings.BASE_DIR, "protected")
    ...
    Secta_FRONTEND_BTN_SIZE_DEFAULT = ""
    Secta_FRONTEND_BTN_SIZE_CHOICES = [
        ("btn-sm", "Small"),
        ("", "Default"),
        ("btn-lg", "Large"),
    ]

    Secta_FRONTEND_BTN_STYLE_DEFAULT = "btn-primary"
    Secta_FRONTEND_BTN_STYLE_CHOICES = [
        ("btn-primary", "Primary"),
    ...
    Secta_FRONTEND_COL_SIZE_DEFAULT = ""
    Secta_FRONTEND_COL_SIZE_CHOICES = [
        ("", "Automatically size"),
        ("12", "Full row"),
        ("6", "Half - 1/2 column"),
        ("4", "Thirds - 1/3 column"),
    ...
    Secta_FRONTEND_COL_BREAK_DEFAULT = "md"
    Secta_FRONTEND_COL_BREAK_CHOICES = [
        ("", "Always expanded"),
    ...
    Secta_FRONTEND_NAVBAR_FORMAT_DEFAULT = ""
    Secta_FRONTEND_NAVBAR_FORMAT_CHOICES = [
        ("", "Default Bootstrap Navbar"),
        ("Secta-navbar-center", "Centered logo at top"),
    ]

    Secta_FRONTEND_NAVBAR_COLOR_SCHEME_DEFAULT = "navbar-light"
    Secta_FRONTEND_NAVBAR_COLOR_SCHEME_CHOICES = [
        ("navbar-light", "Light - for use with a light-colored navbar"),
        ("navbar-dark", "Dark - for use with a dark-colored navbar"),
    ]

    Secta_FRONTEND_NAVBAR_CLASS_DEFAULT = "bg-light"

    Secta_FRONTEND_NAVBAR_COLLAPSE_MODE_DEFAULT = "navbar-expand-lg"
    Secta_FRONTEND_NAVBAR_COLLAPSE_MODE_CHOICES = [
        (
            "",
    ...
    Secta_FRONTEND_THEME_DEFAULT = ""
    Secta_FRONTEND_THEME_CHOICES = [
    ...
    Secta_FRONTEND_TEMPLATES_BLOCKS = {
        "cardblock": [
            (
                "sectacms/blocks/card_block.html",
                "Card",
            ),
            (
                "sectacms/blocks/card_head.html",
                "Card with header",
            ),
            (
                "sectacms/blocks/card_foot.html",
                "Card with footer",
            ),
            (
                "sectacms/blocks/card_head_foot.html",
                "Card with header and footer",
            ),
            (
                "sectacms/blocks/card_blurb.html",
                "Blurb - rounded image and no border",
            ),
            (
                "sectacms/blocks/card_img.html",
                "Cover image - use image as background",
            ),
        ],
        "cardgridblock": [
            (
                "sectacms/blocks/cardgrid_group.html",
                "Card group - attached cards of equal size",
            ),
            (
                "sectacms/blocks/cardgrid_deck.html",
                "Card deck - separate cards of equal size",
            ),
            (
                "sectacms/blocks/cardgrid_columns.html",
        ...
        "pagelistblock": [
            (
                "sectacms/blocks/pagelist_block.html",
                "General, simple list",
            ),
            (
                "sectacms/blocks/pagelist_list_group.html",
                "General, list group navigation panel",
            ),
            (
                "sectacms/blocks/pagelist_article_media.html",
                "Article, media format",
            ),
            (
                "sectacms/blocks/pagelist_article_card_group.html",
                "Article, card group - attached cards of equal size",
            ),
            (
                "sectacms/blocks/pagelist_article_card_deck.html",
                "Article, card deck - separate cards of equal size",
            ),
            (
                "sectacms/blocks/pagelist_article_card_columns.html",
        ...
        "pagepreviewblock": [
            (
                "sectacms/blocks/pagepreview_card.html",
                "Card",
            ),
            (
                "sectacms/blocks/pagepreview_form.html",
                "Form inputs",
            ),
        ],
    ...
    Secta_FRONTEND_TEMPLATES_PAGES = {
        ...
        "*": [
            ...
            (
                "sectacms/pages/web_page.html",
                "Web page showing title and cover image",
            ),
            (
                "sectacms/pages/web_page_notitle.html",
                "Web page without title and cover image",
            ),
            (
                "sectacms/pages/home_page.html",
                "Home page without title and cover image",
            ),
            (
                "sectacms/pages/base.html",
    ...
    Secta_BANNER = None
    Secta_BANNER_BACKGROUND = "#ff0"
    Secta_BANNER_TEXT_COLOR = "#000"
...
Secta_settings = _DefaultSettings()
