...
from sectacms import __version__
...
def global_admin_css():
    return format_html(
        ...
        static("sectacms/css/Secta-admin.css"),
        __version__,
    )
...
def collapsible_js():
    return format_html(
        '<script src="{}?v={}"></script>',
        static("sectacms/js/Secta-editor.js"),
        __version__,
    )
...
def register_icons(icons):
    ...
    icons.append("sectacms/icons/cr-align-left.svg")
    icons.append("sectacms/icons/cr-check-square-o.svg")
    icons.append("sectacms/icons/cr-columns.svg")
    icons.append("sectacms/icons/cr-desktop.svg")
    icons.append("sectacms/icons/cr-font.svg")
    icons.append("sectacms/icons/cr-google.svg")
    icons.append("sectacms/icons/cr-hand-pointer-o.svg")
    icons.append("sectacms/icons/cr-hashtag.svg")
    icons.append("sectacms/icons/cr-header.svg")
    icons.append("sectacms/icons/cr-list-alt.svg")
    icons.append("sectacms/icons/cr-map.svg")
    icons.append("sectacms/icons/cr-newspaper-o.svg")
    icons.append("sectacms/icons/cr-puzzle-piece.svg")
    icons.append("sectacms/icons/cr-recycle.svg")
    icons.append("sectacms/icons/cr-stop.svg")
    icons.append("sectacms/icons/cr-th-large.svg")
    icons.append("sectacms/icons/cr-universal-access.svg")
    icons.append("sectacms/icons/cr-usd.svg")
    icons.append("sectacms/icons/cr-window-maximize.svg")
    icons.append("sectacms/icons/cr-window-minimize.svg")
    return icons
...
def Secta_forms(user, editable_forms):
    """
    Add our own sectaFormPage to editable_forms, since wagtail is unaware
    ...
    """
    from sectacms.models import sectaFormMixin
    from wagtail.contrib.forms.models import FormMixin

    form_models = [
        model
        for model in get_page_models()
        if issubclass(model, (FormMixin, sectaFormMixin))
    ]
